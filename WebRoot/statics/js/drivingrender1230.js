...
/**
 * 驾车路线规划插件
 * @class Lib.AMap.DrivingRender
 */
Lib.AMap.DrivingRender = function() {
	var me = this;
	...
	me.view.createInfowindowContent = function(data) { //创建起始点、终止点、途经点infowindow的内容
		...
		/*		var s
		 ...
		 c.push('    <div class="amap-lib-infowindow-content-title"><b>'+data.name+'</b></div>');
		 c.push('    <div class="amap-lib-infowindow-content-content">');
		 c.push('        <div class="amap-lib-infowindow-content-content-wrap">');
		 //c.push('            <div class="amap-lib-marker-'+(data.type=='start'?'from':'to')+'"></div>');
		 c.push('            <div class="amap-lib-infowindow-content-content-desc">');
		 //c.push('                <div class="amap-lib-name_direc">');
		 //c.push('                    <b>'+(data.type=='start'?'起点':'终点')+'</b>');
		 //c.push('                </div>');
		 c.push('            </div>');
		 c.push('        </div>');
		 c.push('    </div>');
